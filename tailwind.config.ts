  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "aurora": "radial-gradient(ellipse 80% 60% at 50% -20%, rgba(120,119,198,0.3), transparent 70%), radial-gradient(ellipse 60% 50% at 80% 50%, rgba(255,119,198,0.25), transparent 60%), radial-gradient(ellipse 60% 50% at 20% 80%, rgba(120,219,255,0.25), transparent 60%)",
